...
(* CORE_GENERATION_INFO = "fifo_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fifo_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "fifo_design.hwdef" *) 
module fifo_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  fifo_design_fifo_axi_0_0 fifo_axi_0
  ...
  fifo_design_processing_system7_0_0 processing_system7_0
  ...
  fifo_design_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  fifo_design_smartconnect_0_0 smartconnect_0
