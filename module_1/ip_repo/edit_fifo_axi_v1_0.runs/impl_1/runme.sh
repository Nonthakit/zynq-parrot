...
HD_PWD='/home/chaiwn/ip_repo/edit_fifo_axi_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_axi_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_axi_v1_0.tcl -notrace
