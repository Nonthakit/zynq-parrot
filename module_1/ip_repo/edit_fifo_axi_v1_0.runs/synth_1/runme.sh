...
HD_PWD='/home/chaiwn/ip_repo/edit_fifo_axi_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_axi_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_axi_v1_0.tcl
