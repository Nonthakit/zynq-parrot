...
HD_PWD='/home/chaiwn/project_1_fifo_design/project_1_fifo_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_design_wrapper.tcl -notrace
