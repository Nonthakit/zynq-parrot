...
HD_PWD='/home/chaiwn/project_1_fifo_design/project_1_fifo_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_design_wrapper.tcl
